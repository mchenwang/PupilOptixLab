...
int main() {
...

    {
        ...
        Pupil::EventBinder<Pupil::pt::EPTEvent::SppFinished>([&](void *) {
            auto &frame_buffer =
                Pupil::util::Singleton<Pupil::GuiPass>::instance()->GetCurrentRenderOutputBuffer().shared_buffer;
            ...
            memset(image, 0, size);
            Pupil::cuda::CudaMemcpyToHost(image, frame_buffer.cuda_ptr, size * sizeof(float));
