...
void ShadowRayPass::SetScene(Pupil::World *world) noexcept {
...

    {
        ...
        {
            using HitGroupDataRecord = optix::ProgDataDescPair<ShadowRayPassSBTType::HitGroupDataType>;
        ...
        {
            optix::ProgDataDescPair<ShadowRayPassSBTType::MissDataType> miss_data = {
