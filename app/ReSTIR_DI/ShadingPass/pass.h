...
struct ShadingPassSBTType {
    using RayGenDataType = ShadingPassRayGenData;
    using MissDataType = ShadingPassMissData;
    using HitGroupDataType = ShadingPassHitGroupData;
};
