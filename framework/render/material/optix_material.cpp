...
MATERIAL_LOAD_FUNC(Hair) {
    Pupil::optix::material::Hair ret;
    auto tex_mngr = util::Singleton<cuda::CudaTextureManager>::instance();
    ret.sigma_a = tex_mngr->GetCudaTexture(mat.sigma_a);

    ret.longitudinal_v = make_float3(mat.longitudinal_v.x, mat.longitudinal_v.y, mat.longitudinal_v.z);
    ret.azimuthal_s = mat.azimuthal_s;

    ret.sin_2k_alpha = make_float3(mat.sin_2k_alpha.x, mat.sin_2k_alpha.x, mat.sin_2k_alpha.z);
    ret.cos_2k_alpha = make_float3(mat.cos_2k_alpha.x, mat.cos_2k_alpha.y, mat.cos_2k_alpha.z);
