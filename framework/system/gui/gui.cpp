        ...
        if (ImGui::BeginMainMenuBar()) {
            if (ImGui::BeginMenu("Menu")) {
                ...
                if (ImGui::MenuItem("Screenshot")) {
                    ...
                    auto stream = util::Singleton<cuda::StreamManager>::instance()->Alloc(cuda::EStreamTaskType::Downloading).Get();
                    CUDA_CHECK(cudaMemcpyAsync(image.data,
                                               reinterpret_cast<const void*>(buffer.system_buffer->cuda_ptr),
